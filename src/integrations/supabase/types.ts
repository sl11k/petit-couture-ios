  ...
  public: {
    Tables: {
      ...
      header_nav_items: {
        ...
        Relationships: [
          {
            foreignKeyName: "header_nav_items_category_id_fkey";
            columns: ["category_id"];
            isOneToOne: false;
            referencedRelation: "categories";
            referencedColumns: ["id"];
      ...
      season_picks: {
        ...
        Relationships: [
          {
            foreignKeyName: "season_picks_product_id_fkey";
            columns: ["product_id"];
            isOneToOne: false;
            referencedRelation: "products";
            referencedColumns: ["id"];
      ...
      shop_by_category_items: {
        ...
        Relationships: [
          {
            foreignKeyName: "shop_by_category_items_category_id_fkey";
            columns: ["category_id"];
            isOneToOne: false;
            referencedRelation: "categories";
            referencedColumns: ["id"];
    ...
    Functions: {
      ...
      get_product_variants_with_stock: {
        ...
        Returns: {
          ...
          compare_at_price_override: number;
          image_url: string;
          is_active: boolean;
          option_values: Json;
    ...
    Enums: {
      ...
      order_status:
        ...
        | "fraud"
        | "pending_customer";
      payment_method: "cod" | "card" | "apple_pay" | "bank_transfer" | "tabby" | "tamara";
    };
    CompositeTypes: {
      [_ in never]: never;
    };
