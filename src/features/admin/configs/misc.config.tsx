...
categoriesConfig.form = [
  ...
  {
    key: "parent_id",
    label: { ar: "التصنيف الأب (اتركه فارغاً لتصنيف رئيسي)", en: "Parent category (leave empty for top-level)" },
    type: "lookup",
    helpText: {
      ar: "اختر تصنيف أب إذا كان هذا تصنيف فرعي — سيظهر كقائمة منسدلة تحت الأب في الهيدر.",
      en: "Pick a parent to make this a sub-category — it will appear as a dropdown under the parent in the header.",
    },
    lookup: {
      table: "categories",
