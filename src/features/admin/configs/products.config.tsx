...
productsConfig.form = [
  {
    key: "name_ar",
    label: { ar: "الاسم العربي", en: "Name (AR)" },
    type: "text",
    required: true,
    maxLength: 200,
  },
  {
    key: "name_en",
    label: { ar: "الاسم الإنجليزي", en: "Name (EN)" },
    type: "text",
    required: true,
    maxLength: 200,
  },
  {
    key: "slug",
    label: { ar: "Slug", en: "Slug" },
    type: "text",
    required: true,
    pattern: "^[a-z0-9-]+$",
    helpText: { ar: "حروف صغيرة وأرقام وشرطة", en: "lowercase letters, numbers and dashes" },
  },
  {
    key: "sku",
    label: { ar: "SKU الأساسي (للمنتج)", en: "Base SKU (product)" },
    type: "text",
    helpText: {
      ar: 'كود عام للمنتج. لو عندك كود مختلف لكل مقاس، عبّيه في قسم "المقاسات والأكواد" بالأسفل.',
      en: 'A general code for the product. If each size has its own code, fill them in the "Sizes & SKUs" section below.',
    },
  },
  ...
  },
  {
    ...
    label: { ar: "السعر قبل الخصم", en: "Compare-at price" },
    type: "number",
    min: 0,
    step: 0.01,
  },
  ...
  {
    key: "tax_rate",
    label: { ar: "ضريبة القيمة المضافة", en: "Tax rate" },
    type: "number",
    min: 0,
    max: 1,
    step: 0.01,
...

  {
    key: "stock",
    label: {
      ar: "المخزون الإجمالي (يحسب تلقائياً من المستودعات)",
      en: "Total stock (auto from warehouses)",
    },
    type: "number",
    min: 0,
    defaultValue: 0,
    helpText: {
      ar: "يتم تحديثه تلقائياً عند توزيع المخزون على المستودعات",
      en: "Auto-synced from warehouse inventory",
    },
  },
  {
    key: "low_stock_threshold",
    label: { ar: "حد المخزون المنخفض", en: "Low stock threshold" },
    type: "number",
    min: 0,
    defaultValue: 5,
  },
  {
    key: "warehouse_stock",
    label: { ar: "توزيع المخزون على المستودعات", en: "Stock per warehouse" },
    type: "warehouseStock",
    fullWidth: true,
    helpText: {
      ar: "اختر المستودعات التي يتوفر فيها المنتج وحدد الكمية لكل مستودع",
      en: "Pick the warehouses that carry this product and set the quantity for each",
    },
  },
  {
    key: "weight",
...

  {
    key: "images",
    label: {
      ar: "صور المنتج (اسحب لإعادة الترتيب — الأولى هي الرئيسية)",
      en: "Product images (drag to reorder — first is main)",
    },
    type: "gallery",
  ...
  {
    key: "video_url",
    label: { ar: "الفيديو الرئيسي", en: "Main video" },
    type: "video",
    bucket: "product-media",
    folder: "videos",
  },
  {
    key: "videos",
    label: { ar: "معرض الفيديوهات", en: "Video gallery" },
    type: "videoGallery",
    bucket: "product-media",
    folder: "videos",
    maxItems: 10,
...

  {
    ...
    fullWidth: true,
    helpText: {
      ar: "تظهر للعميل كاملة وواضحة داخل نافذة دليل المقاسات.",
      en: "Shown clearly in the customer size guide modal.",
    },
  },
  {
...

  {
    key: "attributes",
    label: {
      ar: "تصنيفات فرعية (عمر، شكل، خامة …)",
      en: "Sub-attributes (age, shape, material …)",
    },
  ...
  {
    key: "is_active",
    label: { ar: "نشط في المتجر", en: "Visible in store" },
    type: "boolean",
    defaultValue: true,
  },
  {
    key: "allow_preorder",
    label: { ar: "السماح بالطلب المسبق", en: "Allow preorder" },
    type: "boolean",
  },
  {
    key: "hide_when_out_of_stock",
    label: { ar: "إخفاء عند نفاد المخزون", en: "Hide when out of stock" },
    type: "boolean",
  },

  {
    key: "short_description_ar",
    label: { ar: "وصف مختصر (AR)", en: "Short description (AR)" },
    type: "textarea",
    rows: 2,
  },
  {
    key: "short_description_en",
    label: { ar: "وصف مختصر (EN)", en: "Short description (EN)" },
    type: "textarea",
    rows: 2,
  },
  {
