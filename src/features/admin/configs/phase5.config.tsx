...
export const abTestsConfig: AdminPageConfig = {
  ...
  form: [
    ...
    { key: "variant_a", label: { ar: "الإصدار A (JSON)", en: "Variant A (JSON)" }, type: "json" },
    { key: "variant_b", label: { ar: "الإصدار B (JSON)", en: "Variant B (JSON)" }, type: "json" },
    { key: "is_active", label: { ar: "نشط", en: "Active" }, type: "boolean", defaultValue: true },
  ],
  actions: { create: true, edit: true, delete: true, export: true },
};
...
export const notificationRulesConfig: AdminPageConfig = {
  ...
  form: [
    ...
    { key: "channels", label: { ar: "القنوات (JSON array)", en: "Channels (JSON array)" }, type: "json",
...
export const notificationTemplatesConfig: AdminPageConfig = {
  ...
  form: [
    ...
    { key: "variables", label: { ar: "المتغيرات (JSON)", en: "Variables (JSON)" }, type: "json" },
    { key: "description", label: { ar: "الوصف", en: "Description" }, type: "textarea", rows: 2 },
...
export const loyaltyTransactionsConfig: AdminPageConfig = {
  ...
  form: [
    ...
    { key: "metadata", label: { ar: "بيانات إضافية (JSON)", en: "Metadata (JSON)" }, type: "json" },
  ],
...
export const reviewsConfig: AdminPageConfig = {
  ...
  form: [
    ...
    { key: "images", label: { ar: "الصور (JSON array)", en: "Images (JSON array)" }, type: "json" },
  ],
  actions: { create: true, edit: true, delete: true, export: true },
};
...
export const siteThemesConfig: AdminPageConfig = {
  ...
  form: [
    { key: "name", label: { ar: "الاسم", en: "Name" }, type: "text", required: true },
    { key: "colors", label: { ar: "الألوان (JSON)", en: "Colors (JSON)" }, type: "json" },
    { key: "fonts", label: { ar: "الخطوط (JSON)", en: "Fonts (JSON)" }, type: "json" },
    { key: "branding", label: { ar: "الهوية (JSON)", en: "Branding (JSON)" }, type: "json" },
    { key: "components", label: { ar: "المكوّنات (JSON)", en: "Components (JSON)" }, type: "json" },
    { key: "tokens", label: { ar: "الرموز (JSON)", en: "Tokens (JSON)" }, type: "json" },
...
export const shippingZonesConfig: AdminPageConfig = {
  ...
  form: [
    ...
    { key: "cities", label: { ar: "المدن (JSON array)", en: "Cities (JSON array)" }, type: "json",
