...
export const ADMIN_NAV: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { to: "/admin/inventory-ledger", label: { ar: "سجل حركات المخزون", en: "Inventory ledger" }, icon: ScrollText },
  ...
  },
  {
    ...
    items: [
      ...
      { to: "/admin/notifications-center", label: { ar: "مركز الإشعارات", en: "Notifications Center" }, icon: Bell },
      { to: "/admin/notif-wasender", label: { ar: "WasenderAPI", en: "WasenderAPI" }, icon: MessageSquare },
      { to: "/admin/notif-events", label: { ar: "أنواع الأحداث", en: "Event Types" }, icon: Bell },
      { to: "/admin/notif-templates", label: { ar: "قوالب الإشعارات", en: "Notif. Templates" }, icon: Mail },
      { to: "/admin/notif-queue", label: { ar: "قائمة الإرسال", en: "Notif. Queue" }, icon: Bell },
      { to: "/admin/notif-logs", label: { ar: "سجل الإرسال", en: "Notif. Logs" }, icon: Bell },
      { to: "/admin/notif-analytics", label: { ar: "إحصائيات الإشعارات", en: "Notif. Analytics" }, icon: Bell },
      { to: "/admin/notif-admins", label: { ar: "مستلمو الإدارة", en: "Admin Recipients" }, icon: Users },
      { to: "/admin/notif-broadcast", label: { ar: "الحملات الجماعية", en: "Broadcasts" }, icon: Megaphone },
      { to: "/admin/notif-providers", label: { ar: "المزودون", en: "Providers" }, icon: Bell },
      { to: "/admin/notifications", label: { ar: "الإشعارات (قديم)", en: "Notifications (legacy)" }, icon: Bell },
