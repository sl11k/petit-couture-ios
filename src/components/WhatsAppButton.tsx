...
export function WhatsAppButton() {
  ...
  return (
    <a
      ...
      className="fixed bottom-[calc(80px+env(safe-area-inset-bottom))] right-4 z-50 flex h-14 w-14 items-center justify-center rounded-xl bg-[#25D366] text-white shadow-lg transition hover:scale-110 active:scale-95 lg:bottom-8 lg:right-8"
    >
