...
const NAV_GROUPS: NavGroup[] = [
  {
    ...
    items: [
      ...
      { to: "/admin/analytics", label: "التقارير", icon: BarChart3 },
    ],
  },
  {
    label: "المبيعات",
  ...
  },
  {
    label: "الاتصالات",
    items: [
      { to: "/admin/notifications", label: "الإشعارات", icon: Bell, badge: "soon" },
      { to: "/admin/messages", label: "الرسائل", icon: MessageSquare, badge: "soon" },
