...
import { getOtoAccessToken, otoCreateOrder } from "./oto.server";
  ...
  .handler(async ({ data, context }) => {
    ...
    const { data: shipment } = await supabaseAdmin
      ...
      .insert({
        ...
        weight_kg: Number(order.total_weight_kg || 1),
