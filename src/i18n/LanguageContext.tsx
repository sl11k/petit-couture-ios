...
const dictionaries: Record<Lang, Dict> = {
  en: {
    ...
    wishlist: {
      ...
      shareTitle: "My Le Petit Paradis wishlist",
      shareText: "Take a look at the pieces I'm loving on Le Petit Paradis.",
    ...
    account: {
      ...
      titleSignedIn: "Your Le Petit Paradis account",
  ...
  ar: {
    ...
    shopAll: "تسوّق الكل",
    footer: "لو بوتي باراديس · الرياض · دبي · باريس",
    ...
    wishlist: {
      ...
      shareTitle: "قائمة مفضلتي في لو بوتي باراديس",
      shareText: "ألقِ نظرة على القطع التي أحبّها في لو بوتي باراديس.",
    ...
    account: {
      ...
      titleSignedIn: "حسابك في لو بوتي باراديس",
